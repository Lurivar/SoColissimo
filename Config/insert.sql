...
INSERT INTO `colissimo_pickup_point_area_freeshipping_dom` (`id`, `area_id`, `delivery_mode_id`, `cart_amount`)
VALUES
	(1, '1', '1', NULL);

-- add relais delivery mode
INSERT INTO `colissimo_pickup_point_area_freeshipping_pr` (`id`, `area_id`, `delivery_mode_id`, `cart_amount`)
VALUES
	(1, '1', '2', NULL);
